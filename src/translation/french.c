...
static translation_string all_strings[] = {
    ...
    {TR_CONFIG_RANDOM_COLLAPSES_TAKE_MONEY, "Les effondrements aléatoires coûtent de l'argent au lieu de détruire les bâtiments"},
    ...
    {TR_ADVISOR_AVAILABLE_HOUSING_CAPACITY, "Capacité disponible totale :"},
